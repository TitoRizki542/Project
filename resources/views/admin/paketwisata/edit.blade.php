                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('paketwisata.update', ['id' => $paketwisata->id]) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input name="ketersediaan" type="number" value="{{ $paketwisata->ketersediaan }}"
                                    class="form-control @error('ketersediaan') is-invalid @enderror" id="ketersediaan"
                                    placeholder="Masukan Stok Ketersediaan Paket">
                                @error('ketersediaan')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input name="durasi" type="number" class="form-control" value="{{ $paketwisata->durasi }}"
                                    @error('durasi') is-invalid @enderror" id="durasi">
                                @error('durasi')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input name="alamat" type="text"
                                    ...
                                    value="{{ $paketwisata->alamat }}" id="alamat">
                                @error('alamat')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
